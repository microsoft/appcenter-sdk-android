...
public class PushTest {
    ...
    public void setEnabled() throws InterruptedException {
        ...
        verify(channel).enqueue(log.capture(), eq(push.getGroupName()), eq(DEFAULTS_FLAGS));
        ...
        verify(mFirebaseInstanceId).getToken();
        verify(channel).enqueue(any(PushInstallationLog.class), eq(push.getGroupName()), eq(DEFAULTS_FLAGS));
    ...
    public void registerWithoutFirebaseButUseGoogleServicesStringForSenderId() {
        ...
        when(resources.getIdentifier("gcm_defaultS_FLAGSenderId", "string", "com.contoso")).thenReturn(42);
