...
public class IngestionHttp implements Ingestion {
     ...
     * Default base URL.
     */
    private static final String DEFAULT_BASE_URL = "http://in-integration.avalanch.es:8081";
    ...
    private static void doCall(String baseUrl, LogSerializer logSerializer, UUID appSecret, UUID installId, LogContainer logContainer) throws Exception {
        ...
        try {
            ...
            SonomaLog.verbose(LOG_TAG, "Headers: " + urlConnection.getRequestProperties());
            ...
            SonomaLog.verbose(LOG_TAG, payload);
            ...
            SonomaLog.verbose(LOG_TAG, "HTTP response status=" + status + " payload=" + response);
