...
public class NetworkStateHelper implements Closeable {
    ...
    private void updateNetworkType() {
        ...
        try {
             ...
             */
            networkInfo = null;
            AvalancheLog.error("Could not get network info and thus stuck in disconnected state, please check you declared android.permission.ACCESS_NETWORK_STATE");
        }
        AvalancheLog.debug("Active network info=" + networkInfo);
