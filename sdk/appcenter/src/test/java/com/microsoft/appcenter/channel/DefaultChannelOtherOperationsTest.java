...
public class DefaultChannelOtherOperationsTest extends AbstractDefaultChannelTest {
    ...
    public void setLogUrl() {
        ...
        DefaultChannel channel = new DefaultChannel(mock(Context.class), UUIDUtils.randomUUID().toString(), mock(Persistence.class), ingestion, mAppCenterHandler, mockIdentityContext());
    ...
    public void logCallbacks() {
        ...
        DefaultChannel channel = new DefaultChannel(mock(Context.class), UUIDUtils.randomUUID().toString(), mock(Persistence.class), mock(AppCenterIngestion.class), mAppCenterHandler, mockIdentityContext());
    ...
    public void clear() {
        ...
        DefaultChannel channel = new DefaultChannel(mock(Context.class), UUIDUtils.randomUUID().toString(), mockPersistence, mock(AppCenterIngestion.class), mAppCenterHandler, mockIdentityContext());
        channel.addGroup(TEST_GROUP, 50, BATCH_TIME_INTERVAL, MAX_PARALLEL_BATCHES, null, null);
    ...
    public void filter() throws Persistence.PersistenceException {
        ...
        @SuppressWarnings("ConstantConditions")
        DefaultChannel channel = new DefaultChannel(mock(Context.class), UUIDUtils.randomUUID().toString(), persistence, mock(AppCenterIngestion.class), mAppCenterHandler, mockIdentityContext());
        channel.addGroup(TEST_GROUP, 50, BATCH_TIME_INTERVAL, MAX_PARALLEL_BATCHES, null, null);
    ...
    public void groupCallbacks() {
        ...
        Ingestion ingestion = mock(Ingestion.class);
        Channel.Listener listener = spy(new AbstractChannelListener());
        DefaultChannel channel = new DefaultChannel(mock(Context.class), UUIDUtils.randomUUID().toString(), persistence, ingestion, mAppCenterHandler, mockIdentityContext());
        channel.addListener(listener);
    ...
    public void checkSetStorageSizeForwarding() {
        ...
        DefaultChannel channel = new DefaultChannel(mock(Context.class), UUIDUtils.randomUUID().toString(), persistence, mock(Ingestion.class), mAppCenterHandler, mockIdentityContext());
