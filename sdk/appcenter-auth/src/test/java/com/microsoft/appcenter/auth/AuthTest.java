...
public class AuthTest extends AbstractAuthTest {
    ...
    @Test
    public void downloadConfigurationWithoutAuthorityUrlForB2C() throws Exception {
        JSONObject jsonConfig = mock(JSONObject.class);
        when(jsonConfig.toString()).thenReturn("mockConfig");
        whenNew(JSONObject.class).withArguments("mockConfig").thenReturn(jsonConfig);
        JSONArray authorities = mock(JSONArray.class);
    ...
    @Test
    public void downloadConfigurationWithAudienceForB2C() throws Exception {
        JSONObject jsonConfig = mock(JSONObject.class);
        when(jsonConfig.toString()).thenReturn("mockConfig");
        whenNew(JSONObject.class).withArguments("mockConfig").thenReturn(jsonConfig);
        JSONArray authorities = mock(JSONArray.class);
        ...
        when(authority.optBoolean("default")).thenReturn(true);
        when(authority.getString("type")).thenReturn("B2C");
        when(authority.optString("authority_url")).thenReturn("");
        JSONObject audience = mock(JSONObject.class);
        when(authority.optJSONObject("audience")).thenReturn(audience);
        testInvalidConfig(jsonConfig);
    }

    @Test
    public void downloadConfigurationWithAuthorityUrlForAAD() throws Exception {
        JSONObject jsonConfig = mock(JSONObject.class);
        when(jsonConfig.toString()).thenReturn("mockConfig");
        whenNew(JSONObject.class).withArguments("mockConfig").thenReturn(jsonConfig);
        JSONArray authorities = mock(JSONArray.class);
    ...
    @Test
    public void downloadConfigurationWithNoAudienceForAAD() throws Exception {
        JSONObject jsonConfig = mock(JSONObject.class);
        when(jsonConfig.toString()).thenReturn("mockConfig");
        whenNew(JSONObject.class).withArguments("mockConfig").thenReturn(jsonConfig);
        JSONArray authorities = mock(JSONArray.class);
    ...
    @Test
    public void downloadConfigurationWithInvalidAudienceForAAD() throws Exception {
        JSONObject jsonConfig = mock(JSONObject.class);
        when(jsonConfig.toString()).thenReturn("mockConfig");
        whenNew(JSONObject.class).withArguments("mockConfig").thenReturn(jsonConfig);
        JSONArray authorities = mock(JSONArray.class);
        ...
        JSONObject audience = mock(JSONObject.class);
        when(authority.optJSONObject("audience")).thenReturn(audience);
        when(audience.getString("type")).thenReturn("InvalidAudience");
        testInvalidConfig(jsonConfig);
    }
