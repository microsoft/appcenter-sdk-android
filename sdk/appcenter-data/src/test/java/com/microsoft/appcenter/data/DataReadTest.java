...
public class DataReadTest extends AbstractDataTest {
    ...
    public void readOnLineWhenLocalStorageContainsNullOperation() {
        ...
        when(mHttpClientWithRetryer.callAsync(contains(DOCUMENT_ID), anyString(), anyMapOf(String.class, String.class), any(HttpClient.CallTemplate.class), any(ServiceCallback.class))).then(new Answer<ServiceCall>() {
